...
class StocksContainer extends Component {
    ...
    render() {
        ...
        return (<Stocks sort={sort} linkAndToggleType={this.props.linkAndToggleType} stocks={stocks} date={date} setTickerFilter={this.props.setTickerFilter} changeTickerOrder={this.props.changeTickerOrder} {...restOfProps}/>);
